...
public class CarSearchQueryCriteriaConsumer implements Consumer<SearchCriteriaForCar> {

    /**
     * consumer for search criteria
     */
    ...
    public CarSearchQueryCriteriaConsumer(Predicate predicate, CriteriaBuilder builder, Root r) {
        super();
    ...
    @Override
    public void accept(SearchCriteriaForCar param) {
