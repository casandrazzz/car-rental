...
public class EmployeeValidation {
    ...
    public static void firstNameValidation(EmployeeDto employeeDto) throws InvalidEmployeeFirstAndLastName {
        String firstName = employeeDto.getFirstName();    // TODO first char of  first name should be capital
    ...
    public static void lastNameValidation(EmployeeDto employeeDto) throws InvalidEmployeeFirstAndLastName {
        String lastName = employeeDto.getLastName();  // TODO first char of  last name should be capital
    ...
    // This function validates employee email address
    // email adress should contain '@' and no other special character
    public  static  void employeeEmailAddressValidation(EmployeeDto employeeDto) throws InvalidEmployeeEmailAddress {

        String emailAddress = employeeDto.getEmailAddress();
